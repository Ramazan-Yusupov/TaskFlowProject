import { Bell, ChevronDown, CirclePlus, Command, Menu, Sparkles } from "lucide-react";
...
export function DashboardHeader({ onCreateTicket, onOpenNavigation }: DashboardHeaderProps) {
  return (
    <header className="dashboard-header">
      <div className="dashboard-header__title">
        ...
        <div className="workspace-mark" aria-hidden="true"><Sparkles size={18} /></div>
        <div>
