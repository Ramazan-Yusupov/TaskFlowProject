...
export function SideNavigation({
  ...
  return (
    <>
      ...
      <aside
        className={cn("side-navigation", isOpen && "side-navigation--open")}
      >
            ...
            {primaryItems.map(({ label, icon: Icon, active, count }) => (
              <li key={label}>
                ...
                >
                  ...
                  <span>{label}</span>
                  {count && (
                    <em>{label === "Мои задачи" ? taskCount : count}</em>
                  )}
                </a>
              </li>
            ))}
        ...
        <div className="navigation-projects">
          <div className="navigation-label-row">
            <p className="navigation-label">Проекты</p>
            <button
              type="button"
          ...
          <ul className="project-list">
            ...
            <li>
              <a href="#platform">
                <span className="project-dot project-dot--blue" />
                Core platform
              </a>
            </li>
            <li>
        ...
        <div className="navigation-footer">
          <a href="#settings">
            <Settings size={18} aria-hidden="true" /> Настройки
          </a>
          <a href="#help">
            <CircleHelp size={18} aria-hidden="true" /> Центр помощи
          </a>
          <div className="user-card">
            <span className="avatar avatar--me">РЮ</span>
            <div>
              <strong>Рамазан Юсупов</strong>
